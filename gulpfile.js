...
gulp.task('watch', function () {
    ...
    gulp.watch(path.source + '**/*.js', ['babel']);
    gulp.watch(path.source + '**/images/**/*', ['imageCompress']);
    gulp.watch(path.source + 'fonts/**/*', ['fonts']);
});

gulp.task('sequence', gulpSequence('clean', 'pug', 'cleanPugTmpl', 'sass','cleanSassMaps', 'babel', 'plugin', 'imageCompress'));

gulp.task('default', ['pug', 'cleanPugTmpl', 'sass','cleanSassMaps', 'babel', 'plugin', 'imageCompress', 'browserSync', 'fonts', 'watch']);
